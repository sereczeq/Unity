...
public class GameManager : MonoBehaviour
{
	...
	void Start()
	{
		...
		//Sprawdzamy, czy coiny były już ustawiane
		CheckCoins();
    ...
    {
		//Sprawdź, czy wartość Coins była już kiedyś zapisana, jeżeli tak to odczytaj i zapisz do lokalnej zmiennej coins
	...
	public void CoinCollected(int value = 1)
	{
		...
		coins += value;
		//Zapisz nową wartość w PlayerPrefs (wartość zostanie zapisana na dysku i zapamiętana nawet pomiędzy kolejnymi uruchomieniami gry
